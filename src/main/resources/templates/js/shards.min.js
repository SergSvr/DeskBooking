!function (t) {
    ...
    !function (r) {
        ...
        u.prototype = {
            ...
            _fill_yearsView: function (i, a, s, n, r, o, l) {
                ...
                }), w = g - p; w <= m + p; w += p) h = [a], u = null, w === g - p ? h.push("old") : w === m + p && h.push("new"), -1 !== t.inArray(w, y) && h.push("active"), (w < r || w > o) && h.push("disabled"), w === v && h.push("focused"), l !== t.noop && ((c = l(new Date(w, 0, 1))) === e ? c = {} : "boolean" == typeof c ? c = {enabled: c} : "string" == typeof c && (c = {classes: c}), !1 === c.enabled && h.push("disabled"), c.classes && (h = h.concat(c.classes.split(/\s+/))), c.tooltip && (u = c.tooltip)), d += '<span class="' + h.join(" ") + '"' + (u ? ' title="' + u + '"' : "") + ">" + w + "</span>";
            ...
            fill: function () {
                var a, s, n = new Date(this.viewDate), r = n.getUTCFullYear(), o = n.getUTCMonth(),
                    ...
                    d = m[this.o.language].today || m.en.today || "", p = m[this.o.language].clear || m.en.clear || "",
                ...
                if (!isNaN(r) && !isNaN(o)) {
                    ...
                    for (var D, b, k = []; g.valueOf() < w;) {
                        ...
                        var M = g.getUTCDate();
                        this.o.beforeShowDay !== t.noop && ((s = this.o.beforeShowDay(this._utc_to_local(g))) === e ? s = {} : "boolean" == typeof s ? s = {enabled: s} : "string" == typeof s && (s = {classes: s}), !1 === s.enabled && b.push("disabled"), s.classes && (b = b.concat(s.classes.split(/\s+/))), s.tooltip && (a = s.tooltip), s.content && (M = s.content)), b = t.isFunction(t.uniqueSort) ? t.uniqueSort(b) : t.unique(b), k.push('<td class="' + b.join(" ") + '"' + (a ? ' title="' + a + '"' : "") + ' data-date="' + g.getTime().toString() + '">' + M + "</td>"), a = null, D === this.o.weekEnd && k.push("</tr>"), g.setUTCDate(g.getUTCDate() + 1)
                    }
            ...
            moveMonth: function (t, e) {
                ...
                if (!e) return t;
                var i, a, s = new Date(t.valueOf()), n = s.getUTCDate(), o = s.getUTCMonth(), l = Math.abs(e);
                if (e = e > 0 ? 1 : -1, 1 === l) a = -1 === e ? function () {
                    return s.getUTCMonth() === o
                } : function () {
                    return s.getUTCMonth() !== i
                }, i = o + e, s.setUTCMonth(i), i = (i + 12) % 12; else {
        ...
        var d = t.fn.datepicker, p = function (i) {
            ...
            if (this.each(function () {
                ...
                if (!n) {
                    var h = o(this, "date"), d = l(t.extend({}, f, h, r).language), p = t.extend({}, f, d, h, r);
                    e.hasClass("input-daterange") || p.inputs ? (t.extend(p, {inputs: p.inputs || e.find("input").toArray()}), n = new c(this, p)) : n = new u(this, p), e.data("datepicker", n)
                }
        ...
        var m = t.fn.datepicker.dates = {
            ...
            parseDate: function (i, s, n, r) {
                ...
                var h, c, d, p, f, g = {d: "moveDay", m: "moveMonth", w: "moveWeek", y: "moveYear"},
                ...
                var w, D, b = {}, k = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], C = {
                    yyyy: function (t, e) {
    ...
    !function (i) {
        ...
        function n(t, e) {
            var i = t.getBoundingClientRect(), a = t.ownerDocument, s = a.documentElement, n = f(a);
        ...
        function H(t, e) {
            ...
            var i = e.indexOf("tap") >= 0, a = e.indexOf("drag") >= 0, s = e.indexOf("fixed") >= 0,
                n = e.indexOf("snap") >= 0, r = e.indexOf("hover") >= 0;
            if (s) {
        ...
        function $(t) {
            var e = {margin: 0, limit: 0, padding: 0, animate: !0, animationDuration: 300, ariaFormat: Z, format: Z},
                i = {
                    step: {r: !1, t: E},
                    start: {r: !0, t: V},
                    connect: {r: !0, t: Y},
        ...
        function K(t, s, r) {
            ...
            function y(t, e) {
                var i = u(t, s.cssClasses.origin), a = u(i, s.cssClasses.handle);
            ...
            function k(t, e, i) {
                ...
                var n = {}, r = lt.xVal[0], o = lt.xVal[lt.xVal.length - 1], l = !1, h = !1, u = 0;
                return (i = a(i.slice().sort(function (t, e) {
                    return t - e
                })))[0] !== r && (i.unshift(r), l = !0), i[i.length - 1] !== o && (i.push(o), h = !0), i.forEach(function (a, r) {
                    var o, c, d, p, f, g, m, v, y, w = a, D = i[r + 1];
                    if ("steps" === e && (o = lt.xNumSteps[r]), o || (o = D - w), !1 !== w && void 0 !== D) for (o = Math.max(o, 1e-7), c = w; c <= D; c = s(c, o)) {
            ...
            function C(t, e, i) {
                function a(t, e) {
                    var i = e === s.cssClasses.value, a = i ? h : d, n = i ? o : l;
            ...
            function S(t) {
                x();
                var e = t.mode, i = t.density || 1, a = t.filter || !1,
                    s = k(i, e, b(e, t.values || !1, t.stepped || !1)), n = t.format || {to: Math.round};
                return et = st.appendChild(C(s, a, n))
            }

            function _() {
                var t = X.getBoundingClientRect(), e = "offset" + ["Width", "Height"][s.ort];
            ...
            function T(t, e, i) {
                var a, n, r = 0 === t.type.indexOf("touch"), o = 0 === t.type.indexOf("mouse"),
            ...
            function Y(t, e) {
                ...
                var r = [], o = M(it.move, dt, O, {
                        ...
                        locations: nt.slice()
                    }), l = M(it.end, dt, A, {target: t.target, handle: a, listeners: r, handleNumbers: e.handleNumbers}),
                    h = M("mouseout", dt, F, {
                        target: t.target,
                        handle: a,
                        listeners: r,
            ...
            function P(t) {
                t.stopPropagation();
                var e = U(t.calcPoint), i = E(e);
                if (!1 === i) return !1;
                s.events.snap || o(st, s.cssClasses.tap, s.animationDuration), I(i, e, !0, !0), H(), V("slide", i, !0), V("update", i, !0), V("change", i, !0), V("set", i, !0), s.events.snap && Y(t, {handleNumbers: [i]})
            }

            function W(t) {
                var e = U(t.calcPoint), i = lt.getStep(e), a = lt.fromStepping(i);
            ...
            function H() {
                rt.forEach(function (t) {
                    var e = nt[t] > 50 ? -1 : 1, i = 3 + (K.length + e * t);
            ...
            var X, K, Z, tt, et, it = g(), at = v() && m(), st = t, nt = [], rt = [], ot = 0, lt = s.spectrum, ht = [],
                ut = {}, ct = t.ownerDocument, dt = ct.documentElement, pt = ct.body;
            ...
            return function (t) {
                ...
                destroy: function () {
                    ...
                    return nt.map(function (t, e) {
                        var i = lt.getNearbySteps(t), a = ht[e], s = i.thisStep.step, n = null;
                ...
                }, get: J, set: B, reset: function (t) {
                    B(s.start, t)
                }, __moveHandles: function (t, e, i) {
                    N(t, e, nt, i)
                }, options: r, updateOptions: function (t, e) {
                    var i = J(), a = ["margin", "limit", "padding", "range", "animate", "snap", "step", "format"];
                ...
                rt.forEach(function (t) {
                    var e = K[t], a = z(nt, t, 0, !0, !0, !0), r = z(nt, t, 100, !0, !0, !0), o = n[t],
